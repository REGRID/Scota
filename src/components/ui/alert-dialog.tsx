...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonVariants(), "rounded-xl font-bold px-4 py-2 text-xs sm:text-sm bg-emerald-600 hover:bg-emerald-700 text-white cursor-pointer shadow-xs", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "rounded-xl font-bold px-4 py-2 text-xs sm:text-sm border-slate-200 hover:bg-slate-100 text-slate-700 cursor-pointer mt-2 sm:mt-0",
      className
    )}
    {...props}
  />
