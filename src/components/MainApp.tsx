...
export function MainApp({
  ...
  return (
    <main className="min-h-screen bg-slate-100 text-slate-900 dark:bg-slate-950 dark:text-slate-100 flex flex-col font-sans pb-28 md:pb-0 antialiased selection:bg-emerald-500 selection:text-white transition-colors duration-200">
      {/* Toast Notification */}
      {batchToast && (
      ...
      <header className="bg-white/95 text-slate-900 dark:bg-slate-900/95 dark:text-white sticky top-0 z-40 shadow-xs dark:shadow-md pt-[env(safe-area-inset-top,0px)] border-b border-slate-200/90 dark:border-slate-800/90 backdrop-blur-md transition-colors duration-200 w-full max-w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2 sm:gap-4 min-w-0 relative">
          ...
          {/* Center: Clean Primary Navigation Tabs (Desktop only) */}
          <div className="hidden md:flex md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 items-center bg-slate-100 dark:bg-slate-800/90 p-0.5 sm:p-1 rounded-xl sm:rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-2xs shrink-0 z-10">
            <button
              type="button"
